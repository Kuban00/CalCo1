...
public class ThursdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(v -> startActivity(new Intent(ThursdayActivity.this, MenuActivity.class)));

        monday = findViewById(R.id.mondayButton);
        monday.setOnClickListener(v -> startActivity(new Intent(ThursdayActivity.this, MondayActivity.class)));

        tuesday = findViewById(R.id.tuesdayButton);
        tuesday.setOnClickListener(v -> startActivity(new Intent(ThursdayActivity.this, TuesdayActivity.class)));

        wednesday = findViewById(R.id.wednesdayButton);
        wednesday.setOnClickListener(v -> startActivity(new Intent(ThursdayActivity.this, WednesdayActivity.class)));

        friday = findViewById(R.id.fridayButton);
        friday.setOnClickListener(v -> startActivity(new Intent(ThursdayActivity.this, FridayActivity.class)));

        saturday = findViewById(R.id.saturdayButton);
        saturday.setOnClickListener(v -> startActivity(new Intent(ThursdayActivity.this, SaturdayActivity.class)));

        sunday = findViewById(R.id.sundayButton);
        sunday.setOnClickListener(v -> startActivity(new Intent(ThursdayActivity.this, SundayActivity.class)));

        addItem = findViewById(R.id.addItemButton);
        addItem.setOnClickListener(v -> startActivity(new Intent(ThursdayActivity.this, FoodList.class)));

        recyclerView = findViewById(R.id.thursdayRecyclerView);
        ...
        addItemAdapter = new AddItemAdapter(ThursdayActivity.this, addItemList);
        ...
        db.collection("ThursdayAdd").document(Objects.requireNonNull(firebaseAuth.getCurrentUser()).getUid()).collection("User").get().addOnCompleteListener(task -> {
        ...
        reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ThursdayActivity.this, "Coś poszło nie tak!", Toast.LENGTH_LONG).show();
            }
        });
    }
}